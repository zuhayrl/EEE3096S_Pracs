...
int main(void)
{
  ...
  // read the value of pot 1
  pot1 = pollADC();

  //convert into to string (unit32 adc to string)
  snprintf(values, sizeof(values), "%lu", pot1);
  //write to LCD
  writeLCD(values);
  ...
  //get CCR value from ADC
  ccrValue = ADCtoCCR(pot1);
  // set tim3 to ccr
  TIM3 -> CCR3 = ccrValue; //-------
